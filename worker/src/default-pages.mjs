export const DEFAULT_CMS_PAGES = [
  ...
  },
  {
    ...
    "path": "/sponsors.html",
    "title": "Sponsors",
    "body_html": "<section class=\"page-hero\"><div class=\"page-title\"><div class=\"kicker\">Community</div><h1>Sponsors</h1><p>Recognize businesses, alumni, and families who help fund instruments, instruction, travel, meals, uniforms, and events.</p></div></section><section class=\"content\"><div class=\"wrap grid two\"><article class=\"card accent-card\"><span class=\"tag\">Sponsor the band</span><h3>Put local support in the spotlight.</h3><p>Add sponsor levels, benefits, artwork requirements, payment instructions, and contact details.</p><p style=\"margin-top:18px\"><a class=\"btn secondary\" href=\"contact.html\">Ask about sponsoring</a></p></article><article class=\"card\"><span class=\"tag\">Recognition</span><h3>Suggested sponsor levels</h3><p>Placeholder: Eagle Partner, Gold Sponsor, Navy Sponsor, Section Sponsor, and Friend of the Band.</p></article></div></section>",
    "nav_order": 6,
    "is_home": 0,
    "active": 1
  },
