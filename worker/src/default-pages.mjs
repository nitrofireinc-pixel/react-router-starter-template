export const DEFAULT_CMS_PAGES = [
  ...
  },
  {
    ...
    "path": "/sponsors.html",
    "title": "Sponsors",
    "body_html": "<section class=\"page-hero sponsor-hero\"><div class=\"page-title\"><div class=\"kicker\">Community Partners</div><h1>Our Sponsors</h1><p>Local businesses, alumni, and families make opportunities possible for every East Forsyth Band student.</p></div></section><section class=\"content sponsor-content\"><div class=\"wrap\"><div class=\"sponsor-intro\"><div><div class=\"kicker\">Thank you</div><h2>Community support takes center stage.</h2><p>Our sponsors help provide instruments, instruction, travel, meals, uniforms, and unforgettable performance opportunities.</p></div><a class=\"btn primary\" href=\"contact.html\">Become a sponsor</a></div><div class=\"sponsor-directory\"><article class=\"sponsor-card sponsor-featured\"><span class=\"sponsor-mark\">EF</span><div><span class=\"sponsor-level\">Presenting partner</span><h3>Your business here</h3><p>Premier recognition for the community partner leading the way for Eagle Pride.</p></div></article><article class=\"sponsor-card\"><span class=\"sponsor-mark\">★</span><div><span class=\"sponsor-level\">Gold sponsor</span><h3>Support the band</h3><p>Your logo and business name can be featured here.</p></div></article><article class=\"sponsor-card\"><span class=\"sponsor-mark\">♪</span><div><span class=\"sponsor-level\">Navy sponsor</span><h3>Join our community</h3><p>Help students thrive on and off the field.</p></div></article></div><aside class=\"sponsor-cta\"><div><span class=\"sponsor-level\">Sponsor opportunities</span><h2>Put your support in the spotlight.</h2><p>Ask us about sponsor levels, benefits, artwork requirements, payment instructions, and how your business can support the band.</p></div><a class=\"btn secondary\" href=\"contact.html\">Ask about sponsoring</a></aside></div></section>",
    "nav_order": 6,
    "is_home": 0,
    "active": 1
  },
