export const DEFAULT_CMS_PAGES = [
  ...
  },
  {
    ...
    "title": "Fundraising",
    "body_html": "<section class=\"page-hero\"><div class=\"page-title\"><div class=\"kicker\">Support</div><h1>Fundraising</h1><p>Centralize active campaigns, passive giving links, payment information, and fundraiser deadlines.</p></div></section><section class=\"content soft\"><div class=\"wrap\"><div class=\"grid cards\"><article class=\"card\"><span class=\"tag\">Active</span><h3>Current Fundraiser</h3><p>Placeholder for campaign details, student credit rules, order deadlines, and pickup dates.</p></article><article class=\"card\"><span class=\"tag\">Ongoing</span><h3>Restaurant / Spirit Nights</h3><p>Placeholder for local partner nights and percentage-back events.</p></article><article class=\"card accent-card\"><span class=\"tag\">Donate</span><h3>Direct Support</h3><p>Give securely online to support instruments, travel, meals, uniforms, and student opportunities.</p><div class=\"square-donate\"><a class=\"btn primary\" id=\"embedded-checkout-modal-checkout-button\" data-square-checkout data-url=\"https://square.link/u/IIGMHqVQ?src=embd\" href=\"https://square.link/u/IIGMHqVQ?src=embed\" target=\"_blank\" rel=\"noopener noreferrer\">Donate</a></div></article></div></div></section>",
    "nav_order": 5,
    "is_home": 0,
    "active": 1
  },
