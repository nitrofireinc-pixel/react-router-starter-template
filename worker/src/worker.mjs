...
const ASSET_VERSION = 'admin-cms-20260802-48';
...
export function generateStructuredPageHtml(payload = {}) {
  ...
  if (layout === 'sponsors') {
    const sponsorCallout = calloutTitle || calloutText
      ? `<aside class="sponsor-cta" data-cms-block="callout"><div><span class="sponsor-level">Sponsor opportunities</span><h2 data-cms-field="callout_title">${escapeHtml(calloutTitle || 'Sponsor opportunities')}</h2><div data-cms-field="callout_text">${formatRichText(calloutText)}</div></div><a class="btn secondary" href="contact.html">Ask about sponsoring</a></aside>`
      : '';
