...
const ASSET_VERSION = 'mail-tap-select-20260807-1';
...
<div class="mail-recipients">
  <div class="mail-recipient-select-label">Send to <small>Tap to select one or more</small>
    <div id="mail-recipient-select" class="mail-recipient-checklist" role="group" aria-label="Send to CMS users">
      <label class="mail-recipient-option"><input type="checkbox" name="recipient" value="__all__"> <span>All users</span></label>
    </div>
  </div>
