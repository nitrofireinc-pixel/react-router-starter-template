...
const ASSET_VERSION = 'admin-cms-20260802-02';
...
<section id="tab-dashboard" class="cms-panel dashboard-panel"><div class="panel-head"><div><p class="kicker">Administration</p><h1 id="dashboard-welcome">Welcome back</h1><p>Changes save to the shared CMS database and publish to the public East Forsyth Band website.</p></div><a class="btn primary" href="/" target="_blank" rel="noreferrer">View Site</a></div><form id="service-mode-form" class="admin-card stack" hidden><h2>Service mode</h2><label class="checkline"><input name="service_mode" type="checkbox"> Put site into service mode</label><p class="muted">When checked, the public home page redirects to a site under maintenance page.</p><p class="status" id="service-mode-status"></p></form><div id="dashboard-cards" class="dashboard-cards"></div></section>
