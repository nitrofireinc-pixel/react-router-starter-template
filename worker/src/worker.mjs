...
const ASSET_VERSION = 'mail-select-all-toggle-20260807-1';
...
<div class="mail-recipients">
  <label class="mail-recipient-select-label">Send to <small>Tap or click to select one or more</small>
    <select name="recipient" id="mail-recipient-select" multiple size="6" aria-label="Send to CMS users">
