...
function ensureWebAppManifestLink() {
  ...
  if (!document.querySelector('link[rel="apple-touch-icon"]')) {
    ...
    apple.href = '/assets/efhs-blue-regiment-mark.png?v=blue-regiment-mark-20260816';
  ...
  if (!button) {
    ...
    button.innerHTML = `
      <span class="nav-add-home-icon" aria-hidden="true">
        ...
        <img class="nav-add-home-mark" src="/assets/efhs-blue-regiment-mark.png?v=blue-regiment-mark-20260816" alt="" width="16" height="16" decoding="async">
      </span>`;
  ...
  sheet.innerHTML = `
    <div class="add-home-sheet-panel" role="dialog" aria-modal="true" aria-labelledby="add-home-title">
      <div class="add-home-sheet-head">
        <img src="/assets/efhs-blue-regiment-mark.png?v=blue-regiment-mark-20260816" alt="">
        <div>
