...
test('sponsor amount helpers parse display currency into cents', () => {
  ...
  assert.equal(normalizeSquareBuyerPhone('(336) 555-0199'), '+13365550199');
  assert.equal(normalizeSquareBuyerPhone('13365550199'), '+13365550199');
  assert.equal(normalizeSquareBuyerPhone('555'), '');
