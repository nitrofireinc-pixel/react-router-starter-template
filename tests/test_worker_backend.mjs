...
test('refreshHomeHeroBrandMark updates the Band information card logo', () => {
  ...
  assert.match(next, /efhs-blue-regiment-mark\.png\?v=email-list-subscribe-once-20260820/);
...
test('push service worker and web app manifest assets exist', () => {
  ...
  assert.match(workerSrc, /email-list-subscribe-once-20260820/);
